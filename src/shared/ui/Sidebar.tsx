...
const sidebarStyles = 'mr-2 h-full w-42'
const navListStyles = 'flex flex-col gap-2 pl-2'
const sidebarLinkStyles =
	'group flex h-10 w-42 items-center gap-2 rounded-xl px-3 text-md font-medium text-text-main transition-colors'
